...
- 港大 DS Lab 的 OpenHarness {cite}`hkuds2025openharness` —— 第 10 章。
- Joseph Vincent 的 Superpowers {cite}`vincent2025superpowers,vincent2025superpowersrepo` —— 第 11 章。
- lazy-scrum-team Claude Code／Cursor 技能 {cite}`lazyscrumteam2026` —— 第 12 章。
