...
每一份有实质内容的章（第 02 至第 16 章）都在正文下方遵循同一副双节骨架：``## 研究脉络`` 把论证钉在可引用的先前工作之上，``## 动手环节`` 则至少交付一件可跑起来的制品。这些章节是刻意把理论与实践配对的。
...
chapters/04-agent-memory-anatomy
chapters/05-agent-loop-anatomy
chapters/06-fowler-harness-vocabulary
```
...
chapters/07-three-guardians
chapters/08-harness-anatomy
chapters/09-operating-a-harness
```
...
chapters/10-openharness
chapters/11-superpowers
chapters/12-lazy-scrum-team
chapters/13-claude-code
chapters/14-codex
chapters/15-openspec
```
...
chapters/16-where-we-go-from-here
```
